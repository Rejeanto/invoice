...
<head>
    ...
    <link href="<?php echo e(asset('bustrep/css/styles.css')); ?>" rel="stylesheet" />
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('bustrep/assets/img/favicon.png')); ?>" />
...
<body class="nav-fixed">
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <div class="sidenav-menu-heading">Pilihan</div>
                        <!-- Sidenav Link (Charts)-->
                        <a class="nav-link" href="/project_list">
                            ...
                            <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                                ...
                                <a class="nav-item nav-link active" id="wizard1-tab" href="#wizard1" data-bs-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                                    ...
                                    <div class="wizard-step-text">
                                        <div class="wizard-step-text-name">Setup Project</div>
                                    </div>
                                </a>
                                ...
                                <a class="nav-item nav-link" id="wizard2-tab" href="#wizard2" data-bs-toggle="tab" role="tab" aria-controls="wizard2" aria-selected="true">
                                    ...
                                    <div class="wizard-step-text">
                                        <div class="wizard-step-text-name">Project Information</div>
                                    </div>
                                </a>
                                ...
                                <a class="nav-item nav-link" id="wizard3-tab" href="#wizard3" data-bs-toggle="tab" role="tab" aria-controls="wizard3" aria-selected="true">
                                    ...
                                    <div class="wizard-step-text">
                                        <div class="wizard-step-text-name">Billing Plan</div>
                                    </div>
                                </a>
                        ...
                        <form action="/welcome" method="POST">
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="cardTabContent">
                                        ...
                                        <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <select name="service_type" class="form-select form-control" aria-label="Default select example">
                                                                <option selected>Pilih</option>
                                                                <option value="ENGINEERING">ENGINEERING</option>
                                                                <option value="EPC/EPCm">EPC/EPCm</option>
                                                                <option value="ASSET SOLUTION">ASSET SOLUTION</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-lg-6">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label">PIC (Cost Control Team)</label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <input name="project_end_date" type="date">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label class="col-form-label">Total Project Type</label>
                                                    <input type="text" name="total_project_type" class="form-control" id="total_project_type">
                                                </div>
                                                <div class="col-lg-6">
                                            ...
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                                                <input class="btn btn-success" href="#wizard2" type="submit" name="submit" value="Next">
                                    ...
                                    <div class="tab-pane fade show active" id="wizard2" role="tabpanel" aria-labelledby="wizard2-tab">
                                        <div class="row justify-content-center">
                                            <div class="row mt-3">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label">Billing Scheme</label>
                                                            <input type="text" name="billing_scheme" class="form-control" id="billing_scheme">
                                                        </div>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label">Billing %</label>
                                                            <input type="text" name="biling" class="form-control" id="biling">
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label">Cummulative Billing %</label>
                                                            <input type="text" name="cummulative_billing" class="form-control" id="cummulative_billing">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <label class="col-form-label">Billing Value</label>
                                                            <input type="text" name="billing_value" class="form-control" id="billing_value">
                                                        </div>
                                                    </div>

                                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                                                        <input class="btn btn-success" type="submit" name="submit" value="Back">
    ...
    <div class="tab-pane fade" id="wizard3" role="tabpanel" aria-labelledby="wizard3-tab">
        <div class="row justify-content-center">
            <div class="mt-3">
                <h5>Progress Claim Online (By System)</h5>
                <div>
                    <p>How many day(s) required form submission to apprroval</p>
                    <div class="col-md-2">
                        <input type="number" class="form-control" id="inputZip" name="progress_by_system">
                    </div>
                </div>

                <div class="container mt-2">
                    <label for="start" class="form-label">Subsmission Date</label>
                    <input name="subs_date_1" type="date">
                    <label for="start" class="form-label">Approval Date</label>
                    <input name="approval_date_1" type="date">
                </div>
            </div>
            <div class="mt-3">
                <h5>Progress Claim Online (Hardcopy Document)</h5>
                <div>
                    <p>How many day(s) required form submission to apprroval</p>
                    <div class="col-md-2">
                        <input type="number" class="form-control" id="inputZip" name="progress_hardcopy">
                    </div>
                </div>
                <div class="container mt-2">
                    <label for="start" class="form-label">Subsmission Date</label>
                    <input name="subs_date_2" type="date">
                    <label for="start" class="form-label">Approval Date</label>
                    <input name="approval_date_2" type="date">
                    <label for="start" class="form-label">Upload to System Company</label>
                    <input name="upload_to_system_2" type="date">
                </div>
            </div>
            <div class="mt-3">
                ...
                <div>
                    <p>How many day(s) required form submission to apprroval</p>
                    <div class="col-md-2">
                        <input type="number" class="form-control" id="inputZip" name="proforma_invoice">
                    </div>
                </div>
                <div class="container mt-2">
                    <label for="start" class="form-label">Subsmission Date</label>
                    <input name="subs_date_3" type="date">
                    <label for="start" class="form-label">Approval Date</label>
                    <input name="approval_date_3" type="date">
                </div>
            </div>
            <div class="mt-3">
                <h5>Readiness of Supporting Document</h5>
                <div>
                    <p>How many day(s) required form submission to apprroval</p>
                    <div class="col-md-2">
                        <input type="number" class="form-control" id="inputZip" name="readiness_of_supporting">
                    </div>
                </div>
                <div class="container mt-2">
                    <label for="start" class="form-label">Subsmission Date</label>
                    <input name="subs_date_4" type="date">
                    <label for="start" class="form-label">Approval Date</label>
                    <input name="approval_date_4" type="date">
                </div>
            </div>
            <div class="mt-3">
                <h5>Submission of Commercial Invoice</h5>
                <div class="container mt-2">
                    <label for="start" class="form-label">SAP Invoice Creation</label>
                    <input name="sap_invoice_creation_5" type="date">
                    <label for="start" class="form-label">SAP Invoice Submitted</label>
                    <input name="sap_invoice_submitted_5" type="date">
                    <label for="start" class="form-label">Upload Invoice in Company's System</label>
                    <input name="upload_invoice_in_company_5" type="date">
                </div>
                <div class="container mt-2">
                    <label for="start" class="form-label">Approved Invoice in Company's System</label>
                    <input name="approved_invoice_in_company_5" type="date">
                    <label for="start" class="form-label">Payment Approval in Company' System</label>
                    <input name="payment_approval_in_company_5" type="date">
                </div>
            </div>
            <div class="mt-3">
                ...
                <div class="container mt-2">
                    <label for="start" class="form-label">SAP Invoice Creation</label>
                    <input name="sap_invoice_creation_6" type="date">
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\Rejeanto\OneDrive\Documents\coba2-laravel\resources\views//home.blade.php ENDPATH**/ ?>